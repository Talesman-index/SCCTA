              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center">
                ...
                <div className="lg:col-span-6">
                  <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-sm h-56 sm:h-72 lg:h-[380px] bg-slate-950 relative group">
                    ...
                    />
                    <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-slate-950/85 backdrop-blur-md text-[#D4F826] text-[10px] sm:text-[11px] font-extrabold uppercase px-3 py-1.5 rounded-full border border-white/15 shadow">
                      {prog.badge}
                    </div>
                ...
                <div className="lg:col-span-6 space-y-4 sm:space-y-6">
                  <div>
                    <div className="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">
                      ...
                      <span>•</span>
                      <span className="text-[#3B82F6]">SCCTA Pathway</span>
                    </div>
                    ...
                    {prog.features.map((feat, fIdx) => {
                      ...
                      return (
                        <div key={fIdx} className="flex items-start sm:items-center gap-2.5 sm:gap-3">
                          <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-slate-100 flex items-center justify-center shrink-0 mt-0.5 sm:mt-0">
                            <IconComponent className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-900" />
                          </div>
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-3 rounded-xl bg-[#D4F826] hover:bg-[#c6ec15] text-slate-950 font-bold text-xs sm:text-sm transition-all shadow-sm active:scale-95 text-center"
                    >
                      {prog.ctaText}
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1.5 text-xs font-bold text-slate-600 hover:text-slate-950 transition-colors py-2 text-center"
                    >
