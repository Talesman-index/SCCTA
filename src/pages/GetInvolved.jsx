      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Donate */}
            <ScrollReveal delay={100} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all">
              <div className="space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-slate-950 text-[#D4F826] flex items-center justify-center shadow">
                  <Heart className="w-7 h-7 fill-[#D4F826]" />
                </div>
                <h3 className="text-3xl font-extrabold font-display text-slate-950">Donate</h3>
                <div className="text-xs font-bold text-[#3B82F6] uppercase tracking-wider">Give opportunity.</div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-slate-950 hover:bg-[#3B82F6] text-[#D4F826] hover:text-white font-bold text-xs shadow-md transition-all active:scale-95 flex items-center justify-center gap-2"
              >
            ...
            {/* Volunteer */}
            <ScrollReveal delay={200} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all">
              <div className="space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-slate-950 text-[#D4F826] flex items-center justify-center shadow">
                  <Users className="w-7 h-7" />
                </div>
                <h3 className="text-3xl font-extrabold font-display text-slate-950">Volunteer</h3>
                <div className="text-xs font-bold text-[#3B82F6] uppercase tracking-wider">Give your time.</div>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              ...
              <a
                ...
                className="w-full py-3.5 rounded-xl bg-white border border-slate-300 text-slate-950 font-bold text-xs text-center block hover:border-slate-950 hover:bg-slate-50 transition-colors shadow-xs"
              >
                Become a Volunteer →
              </a>
            </ScrollReveal>
            ...
            {/* Partner */}
            <ScrollReveal delay={300} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all">
              <div className="space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-slate-950 text-[#D4F826] flex items-center justify-center shadow">
                  <Building2 className="w-7 h-7" />
                </div>
                <h3 className="text-3xl font-extrabold font-display text-slate-950">Partner With Us</h3>
                <div className="text-xs font-bold text-[#3B82F6] uppercase tracking-wider">Community Alliances.</div>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {DONATION_TIERS.map((tier, idx) => (
              <ScrollReveal 
                key={tier.amount}
                delay={idx * 100}
                className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl hover:border-slate-300 transition-all flex flex-col justify-between space-y-6"
              >
                <div className="space-y-3">
                  <div className="text-4xl font-black font-display text-slate-950">
                    ${tier.amount}
                  </div>
                ...
                <button
                  onClick={onOpenDonate}
                  className="w-full py-3 rounded-xl bg-slate-100 hover:bg-slate-950 hover:text-[#D4F826] text-slate-950 font-bold text-xs transition-all shadow-xs"
                >
                  Sponsor ${tier.amount}
                </button>
              </ScrollReveal>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          {volunteerSubmitted ? (
            <div className="bg-slate-50 border border-slate-200 p-8 sm:p-12 rounded-3xl text-center space-y-4">
              <div className="w-14 h-14 bg-slate-950 text-[#D4F826] rounded-full flex items-center justify-center mx-auto shadow">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-slate-900 shadow-xs" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="email" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-slate-900 shadow-xs" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1">Phone Number</label>
                    <input type="tel" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-slate-900 shadow-xs" />
                  </div>
                </div>
