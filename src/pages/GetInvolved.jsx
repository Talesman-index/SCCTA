      ...
      <section className="bg-slate-950 text-white pt-36 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="SCCTA scholarship presentation" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold font-display tracking-tight text-white leading-[1.08]">
            Be part of their <br />
            <span className="text-[#8cb0bf]">next opportunity.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal delay={100} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="space-y-4">
                <div className="w-14 h-14 rounded-2xl bg-[#8cb0bf] text-[#061326] flex items-center justify-center shadow-md shadow-blue-900/20">
                  <Heart className="w-7 h-7 fill-white text-white" />
                </div>
                <h3 className="text-3xl font-extrabold font-display text-slate-950">Donate</h3>
                <div className="text-xs font-bold text-[#8cb0bf] uppercase tracking-wider">Give opportunity.</div>
            ...
            <ScrollReveal delay={200} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="space-y-4">
                ...
                <div className="text-xs font-bold text-[#8cb0bf] uppercase tracking-wider">Give your time.</div>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              ...
              <a
                ...
                className="w-full py-3.5 rounded-xl bg-white border border-slate-300 text-slate-950 font-bold text-xs text-center block hover:border-[#8cb0bf] hover:text-[#8cb0bf] hover:bg-blue-50/50 transition-all shadow-xs"
              >
                Become a Volunteer →
              </a>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300} className="bg-[#FAF9F5] rounded-3xl p-8 sm:p-10 border border-slate-200 flex flex-col justify-between space-y-8 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="space-y-4">
                ...
                <div className="text-xs font-bold text-[#8cb0bf] uppercase tracking-wider">Community Alliances.</div>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            ...
            {DONATION_TIERS.map((tier, idx) => (
              ...
              >
                <div className="space-y-3">
                  <div className="text-4xl font-black font-display text-[#8cb0bf]">
                    ${tier.amount}
                  </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          {volunteerSubmitted ? (
            <div className="bg-slate-50 border border-slate-200 p-8 sm:p-12 rounded-3xl text-center space-y-4">
              <div className="w-14 h-14 bg-[#8cb0bf] text-[#061326] rounded-full flex items-center justify-center mx-auto shadow-md">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-[#8cb0bf] shadow-xs" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="email" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-[#8cb0bf] shadow-xs" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1">Phone Number</label>
                    <input type="tel" required className="w-full px-4 py-3 rounded-xl border border-slate-300 text-xs bg-white focus:ring-2 focus:ring-[#8cb0bf] shadow-xs" />
                  </div>
                </div>
