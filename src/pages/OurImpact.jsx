...
export default function OurImpact({ setActivePage, onSelectStory, onOpenDonate }) {
  ...
  return (
    <div className="w-full bg-white text-slate-900 font-sans">
      ...
      <section className="bg-slate-950 text-white pt-36 pb-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="SCCTA youth players and coaches" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold font-display tracking-tight text-white leading-[1.08]">
            Bigger than <br />
            <span className="text-[#8cb0bf]">the scoreboard.</span>
          </h1>
      ...
      {/* 02. FEATURED RECOGNITION (SCCTA SCHOLARSHIP WINNERS) */}
      <section className="py-24 bg-[#FAF9F5] border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="bg-[#061326] text-white rounded-3xl p-8 sm:p-14 shadow-2xl border border-white/10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              
              <div className="lg:col-span-7 space-y-6">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider bg-[#8cb0bf] text-[#061326] shadow-sm border border-blue-400/30">
                  <Award className="w-4 h-4 text-white" /> CELEBRATING EXCELLENCE
                </div>

                <h2 className="text-3xl sm:text-5xl font-extrabold font-display text-white leading-tight">
                  SCCTA NJTL College Scholarship Awards
                </h2>

                <div className="text-lg font-bold text-[#8cb0bf]">
                  {essayWinner.name} · Academic & Athletic Honorees
                </div>

                <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
                  Through SCCTA's Beyond the Baseline educational mentoring and junior development programs, Ashley and Isaiah earned $500 collegiate scholarships recognizing their leadership, sportsmanship, and outstanding dedication.
                </p>
      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <ScrollReveal delay={100} className="p-8 rounded-3xl bg-[#FAF9F5] border border-slate-200 space-y-4 hover:shadow-xl hover:border-blue-300 transition-all">
            ...
            <ScrollReveal delay={150} className="p-8 rounded-3xl bg-[#FAF9F5] border border-slate-200 space-y-4 hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="w-12 h-12 rounded-2xl bg-[#8cb0bf] text-[#061326] flex items-center justify-center font-bold shadow-md shadow-blue-900/20">
            ...
            <ScrollReveal delay={200} className="p-8 rounded-3xl bg-[#FAF9F5] border border-slate-200 space-y-4 hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="w-12 h-12 rounded-2xl bg-[#8cb0bf] text-[#061326] flex items-center justify-center font-bold shadow-md shadow-blue-900/20">
            ...
            <ScrollReveal delay={250} className="p-8 rounded-3xl bg-[#FAF9F5] border border-slate-200 space-y-4 hover:shadow-xl hover:border-blue-300 transition-all">
              <div className="w-12 h-12 rounded-2xl bg-[#8cb0bf] text-[#061326] flex items-center justify-center font-bold shadow-md shadow-blue-900/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredStories.map((story, idx) => (
              <ScrollReveal 
                key={story.id} 
                delay={idx * 100}
                className="bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-2xl hover:border-blue-300 transition-all duration-500 flex flex-col justify-between"
              >
                <div>
                  <div className="relative h-60 w-full bg-slate-950 overflow-hidden group">
                    ...
                    />
                    <div className="absolute top-4 left-4 bg-[#061326]/85 backdrop-blur-md text-[#8cb0bf] text-[10px] font-extrabold uppercase px-3 py-1.5 rounded-full border border-white/15 shadow">
                      {story.category}
                    </div>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 space-y-3">
                    ...
                    <p className="text-xs font-bold text-[#8cb0bf]">{story.achievement}</p>
