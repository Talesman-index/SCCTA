      ...
      <section className="bg-slate-950 text-white pt-36 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/15 text-xs font-bold uppercase tracking-wider text-[#D4F826]">
            <Trophy className="w-3.5 h-3.5 text-[#D4F826]" />
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold font-display tracking-tight text-white leading-[1.08]">
            Play. Compete. <br />
            <span className="text-[#D4F826]">Grow.</span>
          </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 text-xs w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-slate-900 bg-white shadow-xs"
                />
              </div>
              ...
              <select 
                ...
                className="px-4 py-2.5 rounded-xl border border-slate-300 text-xs font-semibold text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-slate-900 shadow-xs"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filteredTournaments.map((t, idx) => (
              <ScrollReveal 
                key={t.id}
                delay={idx * 100}
                className="bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-2xl hover:border-slate-300 transition-all duration-500 flex flex-col justify-between group"
              >
                {/* Photo Header */}
                <div className="relative h-64 w-full overflow-hidden bg-slate-950">
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                    ...
                    <span className="px-3 py-1.5 rounded-full text-[11px] font-bold text-white bg-emerald-500/90 backdrop-blur-md flex items-center gap-1.5 shadow-sm">
                      <span className="w-2 h-2 rounded-full bg-[#D4F826] animate-pulse" />
                      {t.status}
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <ScrollReveal key={i} delay={i * 50} className="p-6 rounded-3xl bg-[#FAF9F5] border border-slate-200 text-xs space-y-2 hover:shadow-md transition-all">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-200 overflow-hidden relative">
            <div className="bg-slate-950 p-8 text-white relative">
              ...
              <div className="text-[10px] font-bold text-[#D4F826] uppercase tracking-wider mb-1">
            ...
            <div className="p-8 space-y-5 text-xs text-slate-700">
              <div className="space-y-2 bg-slate-50 p-4 rounded-2xl border border-slate-200">
                ...
                <div className="text-rose-600 font-bold"><strong>Deadline:</strong> {selectedTournamentDetail.deadline}</div>
              </div>
              ...
              <div className="pt-2 flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-2/3 py-3 rounded-xl bg-[#D4F826] hover:bg-[#c6ec15] text-slate-950 font-bold text-center flex items-center justify-center gap-1.5 shadow"
                >
